...
## Now
- [ ] [SIL:2] [S59] validate-replay Phase 2B — build the actual headless deterministic resim runner from `seed + inputHash`, using pure combat helpers; quarantine >2% drift; keep heuristic as the fast pre-filter
- [ ] [SIL:1] [S59] App.jsx extraction slice 11 — extract enemy bullet/player hit resolution and grenade explosion damage into pure modules with regression tests
