...
export const NEW_FEATURES = [
  ...
  "🌊 BOT ROYALE — sixteen bots on a scrolling two-screen arena, shrinking flood, supply drops, placement on the debrief",
  "💀 DEBRIEF NAMES NAMES — the last recorded hit (even the flood) is what killed you; every mode says what the run was worth",
