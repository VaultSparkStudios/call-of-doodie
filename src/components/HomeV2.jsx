    ...
    <div style={page}>
      ...
      <div style={wrap}>
        ...
        <div style={footer}>
          ...
          <a href="/privacy" style={{ ...linkBtn, textDecoration: "none", color: "#666" }}>Privacy</a>
          <a href="/terms" style={{ ...linkBtn, textDecoration: "none", color: "#666" }}>Terms</a>
          <span style={{ color: "#555" }}>© 2026 VaultSpark Studios LLC. All rights reserved.</span>
        </div>
