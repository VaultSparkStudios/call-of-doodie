...
const SecondaryRunAnalysis = lazy(() => import("./DeathScreenSecondaryAnalysis.jsx"));
...
export default function DeathScreen({
  ...
  const [secondaryAnalysisRequested, setSecondaryAnalysisRequested] = useState(false);
