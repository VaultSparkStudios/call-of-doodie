...
import { buildGhostDeathReadout } from "../utils/ghostPath.js";
import GhostTrailCanvas from "./GhostTrailCanvas.jsx";
import { generateScoreCard as generateScoreCardImage } from "../utils/generateScoreCard.js";
...
export default function DeathScreen({
  ...
  // Drawing logic extracted to GhostTrailCanvas (S164 diet).
  ...
  // Score card generation extracted to src/utils/generateScoreCard.js (S164 diet).
  const generateScoreCard = () => generateScoreCardImage({
    DIFFICULTIES, difficulty, kills, wave, bestStreak, score, timeSurvived, level,
    deathMessage, bossRushMode, cursedRunMode, scoreAttackMode, dailyChallengeMode,
    username, playerSkin, fmtTime, replayProofReceipt, replayProofPresenter,
  });
      ...
      <div style={{ textAlign: "center", maxWidth: 460, width: "100%", margin: "auto" }}>
        ...
        {ghostData && ghostData.length > 10 && (
          <div style={{ ...card, marginBottom: 12 }}>
            ...
            <GhostTrailCanvas ghostData={ghostData} replayNonce={replayNonce} replayMode={replayMode} precisionPeakFrame={precisionPeakFrame} />
