...
const META = {
  ...
  visualPack:          { label: "Character Visuals",       desc: "Modern uses the current atlas; Retro restores the original circle-and-emoji cast", tab: "Visual", quick: true, type: "options", options: [{v:"modern",l:"Modern"},{v:"retro",l:"Retro Original"}] },
