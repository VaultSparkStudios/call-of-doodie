...
export function drawGame(ctx, canvas, W, H, gs, refs) {
  ...
  // Off-screen threat direction arrows — computed here, drawn in screen space below
  // so the ADS-zoom transform cannot push them outside the visible canvas edge.
  ...
  // Off-screen threat arrows — drawn in screen space (after zoom restore) so ADS
  // zoom cannot push arrow positions beyond the visual canvas edge. Arrows computed
  // above using world-space W/H; positions are correct for unzoomed screen layout.
