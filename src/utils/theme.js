...
export function tokensToCss() {
  return [
    ...
    "",
    "/* Game surfaces (arena, HUD, pause, perks, debrief) always sit on a dark canvas; keep the dark palette there even under Porcelain Day. */",
    block('[data-cod-surface="game"]', BRAND_TOKENS.dark),
    "",
