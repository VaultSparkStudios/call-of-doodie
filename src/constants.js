...
export const NEW_FEATURES = [
  "💔 Splitter Boss — shatters into 3 fast shards at low HP",
  "🦏 Juggernaut Boss — armored shield absorbs damage, charge attacks",
  "🌀 Summoner Boss — spawns elite minions, invulnerable while they live",
  ...
  "🏟️ Named Arena Layouts — Pillars, Corridors, Cross-Rooms, Bunker (seeded per run)",
  "🎱 Ricochet Pistol — metallic ping, bounces off walls up to 10 times",
  "🎵 Nuclear Kazoo — nasal 3-pellet shotgun blast",
  "🎮 Full Controller Support — RT shoot, R3 dash, aim assist, Xbox/PS detection",
  "📚 Life Coach & 💼 Tech CEO — 2 new enemy types",
  "🏆 49 Achievements — including wave 25, 500 kills, 3 nukes, 10 boss kills",
  ...
  "🗺️ Space & Arctic Map Themes — 8 total arenas with unique atmospheres",
