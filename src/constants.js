...
export const BOSS_GRUDGE_QUOTES = {
  4: { // Karen
    ...
    grudge: ["Oh. YOU. Again.", "I remember what you did to me. My memory is EXCELLENT.", "Back for more? Good. I brought documentation.", "Wave {wave} and you're STILL doing this? I've filed {deaths} formal complaints.", "Oh look. {weapon}. Creative. I've catalogued it {deaths} times already."],
    nemesis: ["I've sent you back more times than you've beaten me. Do the math.", "You keep losing to ME. Me. A woman with a bob haircut.", "I want to speak to whoever designed your strategy. Immediately.", "Wave {wave}. You've died to me {deaths} times. I have the documentation.", "Your {weapon} strategy? One star. Consistent."],
  },
  16: { // Splitter
    ...
    grudge: ["We remember what you did. All of us do.", "Each fragment carries the memory of your last assault.", "We've counted your bullets. We know your patterns.", "Wave {wave}. We remember every {weapon} shot. All of us do.", "You've killed us {deaths} fewer times than we've consumed you."],
    nemesis: ["You've died to us more than we've died to you. The numbers are ours.", "Every version of you falls to us eventually.", "We own the count. You know this.", "By wave {wave} you are still losing to us. The fragments keep count.", "Your {weapon}. Our memory. Wave {wave}. The math remains ours."],
  },
  17: { // Juggernaut
    ...
    grudge: ["We've danced this before.", "You know what I am. I know what you are. Let's finish it.", "The wall holds this time.", "Wave {wave} again. Your {weapon} barely dented me last time.", "You've died {deaths} times to this wall. You keep running anyway."],
    nemesis: ["The math is simple: I've crushed you more than you've stopped me.", "You keep charging into me. I appreciate the commitment.", "My wall. Your face. Repeatedly.", "Wave {wave}. {deaths} losses to me. Your {weapon} strategy has not improved.", "I've crushed you {deaths} times and wave {wave} still won't change that."],
  },
  18: { // Summoner
    ...
    grudge: ["We meet again within the spiral.", "The pattern repeats. You are part of it now.", "You cannot escape a circle. We've proven this.", "Wave {wave}. The circle predicted your return after {deaths} offerings.", "Your {weapon} disturbed my ritual {deaths} times. The void adapts."],
    nemesis: ["You've fallen to my minions more than you've closed my portal. Statistically fascinating.", "The count favors me and my children.", "Every soul lost to my circle strengthens it.", "Wave {wave}. You've fed my portal {deaths} souls. It grows stronger.", "The {weapon} won't close the circle. Wave {wave} belongs to the void."],
  },
  9: { // Landlord
    ...
    grudge: ["Back again? I'm adding a late fee.", "I remember the damage you did. I've itemized it.", "You're on my problem-tenant list. Top three.", "Wave {wave}. That's {deaths} late payments on your permanent record.", "Still bringing a {weapon}? I've added it to the damage claim."],
    nemesis: ["I've evicted you more times than you've evicted me. Keep up.", "You're behind on the kill count AND the rent.", "Some landlords get beaten. I'm not one of them. Historically.", "Wave {wave} and you owe me {deaths} deaths-worth of security deposit.", "You've been evicted {deaths} times. I keep the deposit each time."],
  },
  20: { // The Algorithm
    ...
    grudge: ["You again. Your behavior profile is... interesting.", "Repeat engagement. Exactly as the model predicted.", "We've been here before. My algorithm anticipated this.", "Wave {wave} engagement data collected. Your {weapon} preference: logged.", "You've returned {deaths} times. Your engagement loop is highly predictable."],
